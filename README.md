...
3. ### Créer un dépôt
   ...
   * Dans le menu File, choisissez *New repository*, donnez un nom à votre projet, et cochez la case *Initialize with a Readme* ![Ouvrir un compte](https://github.com/francescodecomite/Creer_un_projet_avec_git/tree/main/images/images/newrep.JPG> "a title")
